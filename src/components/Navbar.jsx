...
const Navbar = () => {
  ...
  return (
    <nav className="navCont">
      ...
      <div className={`left ${isMobileMenuOpen ? 'mobile-menu-open' : ''}`}>
        <ul className="Navbar">
        ...
        <div className="socials">
          ...
          <a href="">
            <Twitter className="scl"/>
          </a>
          <a href="">
            <Instagram className="scl"/>
          </a>
        </div>
        <a href="">
          <button className="ContBtn" onClick={closeMobileMenu}>
            Contact Me
          </button>
        </a>
      </div>
